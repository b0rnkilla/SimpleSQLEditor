...
ORDER BY ic.[key_ordinal];";
            ...
            return await ExecuteStringSetAsync(databaseConnectionString, sql, tableName);
        }
...
FROM dbo.[{tableName}];";
        ...
        private static async Task<IReadOnlyCollection<string>> ExecuteStringSetAsync(string connectionString, string sql, string tableName)
        {
